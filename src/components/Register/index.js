        ...
        return(
            <div>
                ...
                <form onSubmit={this.register} id="register">
                    ...
                    onChange={(e) => this.setState({nome: e.target.value})} placeholder="Digite o nome"  /><br/>
                    ...
                    onChange={(e) => this.setState({password: e.target.value})}  placeholder="Digite a senha" /><br/>
